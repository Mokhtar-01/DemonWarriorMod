...
java.util.HashMap<String, CharacterStrings> csMap = (java.util.HashMap<String, CharacterStrings>) csField.get(null);
...
logger.warn("rename failed: " + e.getMessage());
}
}
...
logger.warn("constructor patch failed: " + e.getMessage());
}
}
}
